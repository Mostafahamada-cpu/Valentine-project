...
const DEMO_REASONS = [];
while (DEMO_REASONS.length < 100) {
    for (let i = 0; i < reasonStarts.length && DEMO_REASONS.length < 100; i++) {
        for (let j = 0; j < reasonMiddles.length && DEMO_REASONS.length < 100; j++) {
            DEMO_REASONS.push(reasonStarts[i] + reasonMiddles[j]);
        }
    }
}
DEMO_REASONS.sort(() => Math.random() - 0.5);

// --- 3. Base Data for Stories ---
...
// --- 4. Base Data for Quizzes ---
const quizTemplates = [
    { q: "Where did we first meet? <br><small style='color:#e91e63; font-style:italic'>(Hint: Choose 'Through friends')</small>", opts: ["At a coffee shop", "Through friends", "At work/school", "Online"], correct: 1 },
    { q: "What is my favorite flower? <br><small style='color:#e91e63; font-style:italic'>(Hint: Choose 'Roses')</small>", opts: ["Roses", "Sunflowers", "Tulips", "Peonies"], correct: 0 },
    { q: "Which song reminds me of you the most? <br><small style='color:#e91e63; font-style:italic'>(Hint: Choose 'A Thousand Years')</small>", opts: ["Perfect", "All of Me", "Just the Way You Are", "A Thousand Years"], correct: 3 },
    { q: "What is my go-to comfort food? <br><small style='color:#e91e63; font-style:italic'>(Hint: Choose 'Pasta')</small>", opts: ["Pizza", "Ice Cream", "Pasta", "Burgers"], correct: 2 },
    { q: "Where was our first vacation together? <br><small style='color:#e91e63; font-style:italic'>(Hint: Choose 'The Beach')</small>", opts: ["The Beach", "The Mountains", "A New City", "A Cabin in the Woods"], correct: 0 },
    { q: "What's my biggest pet peeve? <br><small style='color:#e91e63; font-style:italic'>(Hint: Choose 'Being late')</small>", opts: ["Loud chewing", "Being late", "Bad drivers", "Clutter"], correct: 1 },
    { q: "Who said 'I love you' first? <br><small style='color:#e91e63; font-style:italic'>(Hint: Choose 'I did')</small>", opts: ["I did", "You did", "We said it at the same time", "Still waiting!"], correct: 0 },
    { q: "What is my dream travel destination? <br><small style='color:#e91e63; font-style:italic'>(Hint: Choose 'Maldives')</small>", opts: ["Paris", "Tokyo", "Maldives", "New York"], correct: 2 },
    { q: "What movie can I watch over and over? <br><small style='color:#e91e63; font-style:italic'>(Hint: Choose 'Pride and Prejudice')</small>", opts: ["The Notebook", "Pride and Prejudice", "A Walk to Remember", "About Time"], correct: 1 },
    { q: "What do I love most about you? <br><small style='color:#e91e63; font-style:italic'>(Hint: Choose 'Everything!')</small>", opts: ["Your smile", "Your sense of humor", "Your kindness", "Everything!"], correct: 3 }
];
// Generate 100 quizzes
const DEMO_QUIZZES = [];
while (DEMO_QUIZZES.length < 100) {
    quizTemplates.forEach(template => {
        if(DEMO_QUIZZES.length < 100) {
...
for (let i = 0; i < 100; i++) {
    ...
    DEMO_SONGS.push({
        title: songTitles[idx] + (i >= songTitles.length ? ` (Remastered)` : ''),
        artist: songArtists[idx],
        url: "https://open.spotify.com/track/1234567890" 
    });
}
DEMO_SONGS.sort(() => Math.random() - 0.5);
